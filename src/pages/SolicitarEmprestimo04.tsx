...
const SpanTipoContrato = styled.span`
    ...
    /* font: var(--unnamed-font-style-italic) normal var(--unnamed-font-weight-medium) 21px/28px var(--unnamed-font-family-flexo); */
...
const Select = styled.select`
    ...
    width: 240px;
    height: 62px;
    font: var(--unnamed-font-style-italic) normal var(--unnamed-font-weight-bold) 22px/30px var(--unnamed-font-family-flexo);
    background: var(--unnamed-color-ffffff) ;
