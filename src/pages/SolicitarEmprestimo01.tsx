...
const LabelButton = styled.span`
  ...
  font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-bold)
    var(--unnamed-font-size-32) var(--unnamed-font-family-flexo);
...
const LabelCliente = styled.label`
  ...
  font: var(--unnamed-font-style-normal) normal var(--unnamed-font-weight-bold)
    33px/39px var(--unnamed-font-family-flexo);
  letter-spacing: var(--unnamed-character-spacing-0);
...
const LabelCPF = styled.label`
  margin: 20px auto auto;
  font: var(--unnamed-font-style-normal) var(--unnamed-font-size-32)
